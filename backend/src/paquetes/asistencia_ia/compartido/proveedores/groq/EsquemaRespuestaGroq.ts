    ...
    comandos: {
      ...
      items: {
        anyOf: [
          ...
          comando({ tipo: { const: "crear_relacion" }, refTemporal: { type: "string" }, claseOrigenRef: { type: "string" }, claseDestinoRef: { type: "string" }, tipoRelacion: { const: "asociacion" }, cantidadDestinoPorOrigen: multiplicidad, cantidadOrigenPorDestino: multiplicidad, rolOrigen: cadenaNullable, rolDestino: cadenaNullable }, ["tipo", "refTemporal", "claseOrigenRef", "claseDestinoRef", "tipoRelacion", "cantidadDestinoPorOrigen", "cantidadOrigenPorDestino", "rolOrigen", "rolDestino"]),
